              ...
              {detailsLoading ? (
                ...
                <article className={styles.campaignDetail} aria-labelledby="donate-campaign-title">
                  ...
                  <div className={styles.campaignDetailBody}>
                    ...
                    <div className={styles.shareSection} aria-label={t('donate.shareCampaign')}>
                      <p className={styles.shareLabel}>{t('donate.shareCampaign')}</p>
                      <div className={styles.shareActions}>
                        <button
                          type="button"
                          className={copySuccess ? `${styles.shareCopyBtn} ${styles.copied}` : styles.shareCopyBtn}
                          onClick={handleCopyLink}
                          aria-label={t('donate.copyLink')}
                        >
                          {copySuccess ? (
                          ...
                          <span className={styles.shareCopyText}>{copySuccess ? t('donate.copied') : t('donate.copyLink')}</span>
                        </button>
                        <div className={styles.shareSocialRow}>
                          <span className={styles.shareViaText}>{t('donate.shareVia')}</span>
                          <button type="button" className={styles.shareSocialBtn} onClick={() => openShare('whatsapp')} aria-label="WhatsApp" title="WhatsApp">
                          ...
                          <button type="button" className={styles.shareSocialBtn} onClick={() => openShare('twitter')} aria-label="X (Twitter)" title="X (Twitter)">
                          ...
                          <button type="button" className={styles.shareSocialBtn} onClick={() => openShare('facebook')} aria-label="Facebook" title="Facebook">
